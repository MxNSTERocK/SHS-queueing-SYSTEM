					...
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="card border-left-primary shadow h-100 py-1 text-center text-white" style="background-color: transparent">
								<div class="wrapper">
									<!-- Modified the order of the buttons -->
									<div><a href="index.php?page=users" class="btn btn-warning float-left"><i class="fa fa-archive fa-2x float-left" title="archive"></i></a></div>
									<div class="label"><span>Inactive User</span></div>
								</div>
							</div>
							<br>
								...
								<div class="card-body">
									<table id="example" class="table align-middle mb-0 bg-white">
										...
										<tbody>
											...
											endwhile;
											$users = $conn->query("SELECT * FROM users u WHERE status = 0");
											$i = 1;
